...
class CBraMod(nn.Module):
    def __init__(self, in_dim=200, out_dim=200, d_model=200, dim_feedforward=800, seq_len=30, n_layer=12,
        ...
        self.proj_alignment = nn.Sequential(
    ...
    def forward(self, x, mask=None):
        ...
        out=self.proj_out(feats).squeeze()
        out = self.proj_alignment(out.permute(0, 2, 1))
        
        return {"pooler_output":out,"last_hidden_state":None}
