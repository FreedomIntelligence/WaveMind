...
# Data
# data_path=$prompt_root_folder/data/Instruction_data/EEGsft_total_conv_K_w_unseen.json



# I/O
output_dir=$project_root_path/EEGLLM/LLaVA/checkpoints/WaveMind/WaveMindAblation/WaveMindab_backbone/WaveMindllama_lora


#Start from
# origin_load_path=$project_root_path/EEGLLM/LLaVA/checkpoints/LLAVA/LLAVA_Vicuna/llava_1.5_postNorm_lora

pretrain_mm_mlp_adapter=$origin_load_path/non_lora_trainables.bin
...
deepspeed --master_port=$((RANDOM % 20 + 29500))  $project_root_path/EEGLLM/LLaVA/llava/train/train_mem.py \
    --lora_enable True --lora_r 8 --lora_alpha 128 --mm_projector_lr 5e-5 \
    --deepspeed $project_root_path/EEGLLM/LLaVA/scripts/zero2.json \
    --model_name_or_path $model_name_or_path \
    --version v1 \
    --data_path $data_path \
    --train_data_mode mela \
    ...
    --origin_load_path $origin_load_path \
